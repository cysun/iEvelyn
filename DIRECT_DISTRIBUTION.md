...
iEvelyn 1.0 build 1 is intended for direct download outside the Mac App Store.
...
Use a new output directory for every candidate:
    ...
    IEVELYN_RELEASE_ROOT=/Volumes/galfrey/Xcode/Release/iEvelyn-1.0-1-candidate-1 \
...
4. verifies that the packaged identity is version 1.0 build 1;
...
9. creates the final iEvelyn-1.0-1-macOS.zip plus its SHA-256 digest.
