...
iEvelyn 1.3 build 4 is intended for direct download outside the Mac App Store.
...
Use a new output directory for every candidate:
    ...
    IEVELYN_RELEASE_ROOT=/Volumes/galfrey/Xcode/Release/iEvelyn-1.3-4-candidate-1 \
...
4. verifies that the packaged identity is version 1.3 build 4;
...
9. creates the final iEvelyn-1.3-4-macOS.zip plus its SHA-256 digest.
